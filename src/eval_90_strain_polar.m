function hem = eval_90_strain_polar(hem, param)
    ...
    hem.integrate = @(hem, E) integrate_90_strain_polar(hem, E);
    hem.forward = @(hem, E) forward_90_strain_polar(hem, E);
    hem.forward_fix_t = @(hem, E) forward_90_strain_polar_fix_t(hem, E);

    hem.get_strain_polar = @(hem, E) forward_90_strain_polar(hem, E);
    hem.get_strain_polar = @(hem, E) ...
                                    forward_90_strain_polar_fix_t(hem, E);
end

function [eps, P, hem] = integrate_90_strain_polar(hem, E)
    ...
    eps = hem.integrate_90_strain(hem, E);
...
function [eps, P, hem] = forward_90_strain_polar(hem, E)
    ...
    for k = 1:N
        ...
        [eps(k), P(k), hem] = hem.integrate(hem, Ek);
    end
end


function [eps, P, hem] = forward_90_strain_polar_fix_t(hem, E)
